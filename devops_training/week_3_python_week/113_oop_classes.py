...
from 111_functions import add, sub, div, mult, remainder
...
class python_Calculator:
    ...
    # if operator is -
        ...
        print(str(num1) + " Minus " + str(num2) + " equals: ", 111_functions.sub_values(num1, num2))
    # if operator is *
    elif user_input == "*":
        print(str(num1) + " Times " + str(num2) + " equals: ", functions.multi_values(num1, num2))
    # if operator is /
    elif user_input == "/":
        print(str(num1) + " Divide " + str(num2) + " equals: ", functions.divide_values(num1, num2))
    # if operator is %
    elif user_input == "%":
        print(str(num1) + " Mod " + str(num2) + " equals: ", functions.modo_values(num1, num2))
